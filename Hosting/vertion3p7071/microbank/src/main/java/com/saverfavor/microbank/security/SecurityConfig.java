...
public class  SecurityConfig {
                        ...
                        .authorizeHttpRequests(
                                ...
                                req ->
                                        req.requestMatchers("/login",
                                                        "/api/userRegistration","/activate/**",
                                                        "/api/nominee/save","/api/Referral/save",
                                                        "/api/userRegistration/get","/api/nominee/get")
                                                .permitAll()


                                                .requestMatchers( "/api/UserRegistration/update/{id}",
                                                        "/api/nominee/updateNominee/{id}", "/api/nominee/save",
                                                         "/api/Balance/save", "/api/Balance/{id}",
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(List.of("http://108.181.173.121:7070", "http://108.181.173.121:7070"));  // Add allowed origins
