package com.itshop.ecommerce.jwt;

import com.itshop.ecommerce.entity.Token;
import com.itshop.ecommerce.entity.User;
import com.itshop.ecommerce.repository.TokenRepository;
...
public class JwtService {
    ...
    public boolean isValid(String token, UserDetails user) {
        ...
        boolean validToken = tokenRepository.findByToken(token)
                .map(Token::isLoggedOut)  // Correct way to reference method
                .map(loggedOut -> !loggedOut) // Convert to boolean correctly
                .orElse(false);
