package com.saverfavor.microbank.jwt;
...
public class JwtService {
    ...
    public String generateToken(UserRegistration userRegistration) {
        return Jwts
                .builder()
                .setSubject(userRegistration.getEmail())  // Sets the email as the subject
                .claim("role", userRegistration.getRole())  // Adds the user's role to the token payload
    ...
    public boolean isValid(String token, UserDetails userRegistration) {
        ...
        return (username.equals(userRegistration.getUsername())) && !isTokenExpired(token) && validToken;
    }
